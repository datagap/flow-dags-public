...
listUrl = Variable.get("actris_agent_list_activity_index_url")
buyerUrl = Variable.get("actris_agent_buyer_activity_index_url")
target = Variable.get("actris_agent_activity_datasource")
source = Variable.get("actris_prop_sold_datasource")
...
with DAG(
    dag_id='actris-agent-activity-index',
